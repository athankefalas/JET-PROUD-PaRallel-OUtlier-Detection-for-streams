...
import edu.auth.jetproud.datastructures.vptree.thresholdselectionstrategy.SamplingMedianDistanceThresholdSelectionStrategy;
import edu.auth.jetproud.datastructures.vptree.thresholdselectionstrategy.ThresholdSelectionStrategy;
import edu.auth.jetproud.datastructures.vptree.utils.MetaIterator;
 ...
 */
public class VPTree<P extends Comparable<P>, E extends P> implements SpatialIndex<P, E>, Serializable {
     ...
     * ({@value edu.auth.jetproud.datastructures.vptree.VPTree#DEFAULT_NODE_CAPACITY} points).
     *
     ...
     * capacity ({@value edu.auth.jetproud.datastructures.vptree.VPTree#DEFAULT_NODE_CAPACITY} points).
     *
     * @param distanceFunction the distance function to use to calculate the distance between points
     * @param thresholdSelectionStrategy the function to use to choose distance thresholds when partitioning nodes
     * @param points the points with which this tree should be initially populated; may be {@code null}
