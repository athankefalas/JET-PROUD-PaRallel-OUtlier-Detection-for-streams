package edu.auth.jetproud.datastructures.vptree.utils;

import edu.auth.jetproud.datastructures.vptree.distance.DistanceComparator;
 ...
 */
public class NearestNeighborCollector<P, E extends P> {
